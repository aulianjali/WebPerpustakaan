...
import { DataTableRiwayat } from "@/app/_components/anggota/data-table-riwayat"
import {
  columnsRiwayat,
  type DataRiwayat,
  type DataDipinjam,
  createColumnsDipinjam,
} from "@/app/_components/anggota/columns-riwayat"
    ...
    <div className="flex flex-col min-h-screen bg-[#D9DBF3] text-[#0E4D97]">
      <main className="flex-1 p-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
          ...
          <span className="text-[#0E4D97] font-medium">Riwayat</span>
        </div>
              ...
              <TabsContent value="dipinjam" className="mt-0">
                <div className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-sm text-gray-500">Total: {filteredDataDipinjam.length} data</div>
                  </div>
              ...
              <TabsContent value="riwayat" className="mt-0">
                <div className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-sm text-gray-500">Total: {filteredDataRiwayat.length} data</div>
                  </div>
