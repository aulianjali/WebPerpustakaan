...
export function StatCard({
  ...
  if (isLarge) {
    ...
    return (
      <Card className={`${borderColor} rounded-xl p-6 ${className} relative overflow-hidden`}>
        {/* Background pattern */}
        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className={`w-16 h-16 ${iconBgColor} rounded-xl flex items-center justify-center backdrop-blur-sm`}>
                <div className={textColor}>{icon}</div>
              </div>
              <div>
                <h3 className={`font-medium ${textColor} opacity-90`}>Total</h3>
                <h2 className={`text-xl font-semibold ${textColor}`}>Anggota</h2>
              </div>
            </div>
          </div>
  ...
  return (
    <Card className={`${borderColor} rounded-lg p-4 ${className}`}>
