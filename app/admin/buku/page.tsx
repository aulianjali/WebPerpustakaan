...
import { DataTableBuku } from "@/app/_components/admin/data-table-buku"
import { AddBukuDialog } from "@/app/_components/admin/add-buku-dialog"
import { EditBukuDialog } from "@/app/_components/admin/edit-buku-dialog"
import { DeleteBukuDialog } from "@/app/_components/admin/delete-buku-dialog"
import { ImagePreviewDialog } from "@/app/_components/admin/image-preview-dialog"
import { columnsBuku, type DataBuku } from "@/app/_components/admin/columns-buku"
...
export default function ManajemenBukuPage() {
  ...
  const handleEdit = (id: number) => {
    const buku = dataBuku.find((b) => b.no === id)
    if (buku) {
    ...
    <div className="flex flex-col min-h-screen bg-[#D9DBF3] text-[#0E4D97]">
      <main className="flex-1 p-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
          ...
          <span className="text-[#0E4D97] font-medium">Manajemen Buku</span>
        </div>
          ...
          {isLoading ? (
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-sm text-gray-500">Total: {filteredData.length} buku</div>
              </div>
              ...
              <DataTableBuku
                columns={columnsBuku(handleEdit, handleDelete, handleImagePreview)}
