...
export default function ClientDetailBuku() {
  ...
  const fetchBookDetail = async () => {
    try {
      ...
      // Jika stock_awal tidak tersedia, fallback ke stock
      if (!bookData.stock_awal) {
        bookData.stock_awal = bookData.stock
      }
